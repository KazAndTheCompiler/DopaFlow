    ...
    <>
      ...
      >
        <div style={{ display: "grid", gap: "0.18rem" }}>
          ...
          >
            Mobile should fold the shell into a drawer, not hide half the
            product.
          </span>
        </div>
          ...
          {navItems.map((item) => {
            ...
            return (
              ...
              >
                ...
                <span style={{ flex: 1, fontWeight: isActive ? 700 : 600 }}>
                  {item.label}
                </span>
              </button>
            );
            ...
            {activeProjects.map((project) => {
              ...
              return (
                <button
                  key={project.id}
                  onClick={() =>
                    projects.setActiveProjectId(isActive ? null : project.id)
                  }
                  style={{
                    display: "flex",
                    alignItems: "center",
                    ...
                    width: "100%",
                    border: isActive
                      ? `1px solid ${project.color || "var(--accent)"}`
                      : "1px solid var(--border-subtle)",
                    background: isActive
