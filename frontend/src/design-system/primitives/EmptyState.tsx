...
export function EmptyState({ icon, title, subtitle, ctaLabel, onCta }: EmptyStateProps): JSX.Element {
  return (
    <div
      style={{
        display: "flex",
    ...
    >
      ...
      <div style={{ fontSize: "1.1rem", fontWeight: 600, color: "var(--text-primary)" }}>{title}</div>
