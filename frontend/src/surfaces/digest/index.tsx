          ...
          >
            ...
            {activityTotal === 0 ? (
              <p style={{ margin: 0, color: 'var(--text-secondary)', lineHeight: 1.6 }}>
                There is not enough activity here yet to draw a real conclusion. Use this view after
                a day or week with actual task, focus, or habit activity.
              </p>
            ) : (
              <p style={{ margin: 0, color: 'var(--text-secondary)', lineHeight: 1.6 }}>
          ...
          {(() => {
            const rows = [
              ...
              ...(digest.nutrition_days > 0
                ? [
                    {
                      label: period === 'today' ? 'Calories today' : 'Avg kcal/day',
                      value: period === 'today' ? digest.calories_kcal : digest.avg_kcal,
                      max: 2500,
                      color: '#10b981',
                    },
                  ]
