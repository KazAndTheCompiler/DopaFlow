...
export function CarryForward({
  ...
  const allDecided =
    overdue.length === 0 || overdue.every((task) => decisions[task.id]);
      ...
      {statItems.length > 0 && (
        <div
          style={{
            ...
            borderRadius: "12px",
            background:
              "color-mix(in srgb, var(--state-ok, #10b981) 8%, transparent)",
            border:
              "1px solid color-mix(in srgb, var(--state-ok, #10b981) 20%, transparent)",
            marginBottom: "1rem",
            flexWrap: "wrap",
          }}
        >
        ...
        <div style={{ textAlign: "center", padding: "0.75rem 0 1.25rem" }}>
          <div
            style={{
              ...
              placeItems: "center",
              background:
                "color-mix(in srgb, var(--state-ok, #10b981) 12%, transparent)",
