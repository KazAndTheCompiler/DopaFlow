...
export default function TasksView({
  ...
  const activeCount = visibleTasks.filter(
    (task) =>
      !task.done && task.status !== "done" && task.status !== "cancelled",
  ).length;
  ...
  const compactStats = useMemo(
    () => [
      ...
      },
      {
        ...
        value: overdueCount,
        tone:
          overdueCount > 0 ? "var(--state-overdue)" : "var(--text-secondary)",
        ...
        >
          ...
          >
            ...
            >
              ...
              >
                Use Kanban to keep execution flowing, or switch to Eisenhower
                when the real problem is prioritization rather than volume.
              </span>
            </div>
            <div style={{ display: "flex", gap: "0.4rem", flexWrap: "wrap" }}>
              {compactStats.map((stat) => (
                ...
                >
                  ...
                  <strong style={{ fontSize: "1.2rem", color: stat.tone }}>
                    {stat.value}
                  </strong>
                  <span
                    style={{
      ...
      >
        ...
        >
          ...
          >
            ...
            <strong style={{ fontSize: "var(--text-xl)" }}>
              Capture quickly, then cut the list down to what should actually
              move
            </strong>
            <span
              style={{
            ...
            >
              This surface should help you offload ideas fast, filter the noise,
              and leave only the tasks that deserve attention right now.
            </span>
          </div>
          <div style={{ display: "flex", gap: "0.4rem", flexWrap: "wrap" }}>
            {compactStats.map((stat) => (
