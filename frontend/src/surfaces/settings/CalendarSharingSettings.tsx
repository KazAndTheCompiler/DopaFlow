      ...
      >
        ...
        >
          <StepCard
            ...
            detail="Generate a one-time token with a deliberate lifetime for the device or person you trust."
          />
          <StepCard
            step="2"
            title="Share the setup code"
            detail="Hand over the base URL plus token once. The raw secret is intentionally not recoverable later."
          />
          <StepCard
            step="3"
            title="Mirror the feed"
            detail="The other DopaFlow install subscribes and sees your events as read-only mirrored calendars."
          />
        </div>
      </section>
