...
function SkinCard({ skin, isActive, isPreview, onSelect }: SkinCardProps): JSX.Element {
    ...
    >
      ...
      <div
        style={{
          height: 36,
          borderRadius: "8px",
          background: skin.id === "forest-gradient"
      ...
      {isActive && (
        <div style={{
          ...
          <svg width="6" height="6" viewBox="0 0 10 10" fill="none">
            <path d="M2 5l2.5 2.5L8 3" stroke="var(--text-inverse)" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
          </svg>
        </div>
      )}
      ...
      {skin.preview && (
        <div style={{ display: "flex", gap: "4px", alignItems: "center" }}>
          <div style={{ width: 10, height: 10, borderRadius: "50%", background: skin.preview.accent, flexShrink: 0 }} />
          <div style={{ width: 10, height: 10, borderRadius: "50%", background: skin.preview.surface, border: "1px solid rgba(0,0,0,0.1)", flexShrink: 0 }} />
          <div style={{ width: 10, height: 10, borderRadius: "50%", background: skin.preview.bg, border: "1px solid rgba(0,0,0,0.1)", flexShrink: 0 }} />
        </div>
      )}
...
export function SkinPicker({
 ...
 normalized.author = imported.author;
  ...
  const group = (label: string, items: SkinMeta[]) => (
    <div style={{ display: "grid", gap: "0.5rem" }}>
      <span style={{ fontSize: "var(--text-xs)", fontWeight: 700, color: "var(--text-secondary)", textTransform: "uppercase" as const, letterSpacing: "0.08em" }}>
        {label}
      </span>
        ...
        <div style={{ display: "grid", gap: "0.5rem" }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(120px, 1fr))", gap: "0.5rem" }}>
            {Array.from({ length: 6 }).map((_, i) => (
              <div key={i} style={{ padding: "0.8rem", borderRadius: "14px", border: "1px solid var(--border-subtle)", background: "var(--surface-2)", display: "grid", gridTemplateRows: "auto auto auto", gap: "0.5rem" }}>
 ...
 return null;
      ...
      {/* Import / Export */}
      <div style={{ display: "flex", gap: "0.6rem", flexWrap: "wrap", paddingTop: "0.35rem", borderTop: "1px solid var(--border-subtle)" }}>
        <button
