  ...
  return (
    <div style={cardStyle}>
      ...
      <span style={{ fontSize: 'var(--text-xs)', color: 'var(--text-secondary)' }}>
        Finds task lines in your vault task files that are not yet in DopaFlow. Review before
        importing.
      </span>
      ...
      {preview && (
        <>
          <div style={{ fontSize: 'var(--text-xs)', color: 'var(--text-secondary)' }}>
            {preview.total_scanned} scanned · {preview.importable.length} importable ·{' '}
            {preview.known.length} already known · {preview.skipped} skipped
          </div>
          ...
          {preview.importable.length > 0 ? (
            <div style={{ display: 'grid', gap: '0.3rem' }}>
              ...
              <div
                style={{ maxHeight: '14rem', overflowY: 'auto', display: 'grid', gap: '0.2rem' }}
              >
