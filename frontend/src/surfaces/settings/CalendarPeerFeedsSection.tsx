...
import { describeConnectionError, inputStyle, MetaPill, panelStyle, StatusBadge } from "./CalendarSharingShared";
          ...
          <label style={{ display: "grid", gap: "0.4rem" }}>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "1fr auto", gap: "0.55rem" }}>
              <input
                ...
                style={inputStyle}
              />
              <Button onClick={onApplySetupCode} disabled={loading || !setupCode.trim()} variant="secondary" style={{ opacity: loading ? 0.6 : 1 }}>
                Apply
              </Button>
            </div>
          </label>
