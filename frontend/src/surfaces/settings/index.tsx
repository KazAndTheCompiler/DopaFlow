    ...
    <div style={{ display: "grid", gap: "1rem" }}>
      ...
      <section style={groupStyle} id="settings-integrations-overview">
        ...
        <div style={groupHeaderStyle}>
          ...
          <span style={groupDescriptionStyle}>
            See the integration picture first: what is connected, what is
            degraded, and what still lives only on this device.
          </span>
        </div>
      ...
      <section style={groupStyle}>
        ...
        <div style={groupHeaderStyle}>
          ...
          <span style={groupDescriptionStyle}>
            Tune the shell, color system, and density. These are the settings
            that change how DopaFlow feels every time you open it.
          </span>
        </div>
        <SkinPicker
          current={skin.skin}
      ...
      <section style={groupStyle} id="settings-vault">
        ...
        <div style={groupHeaderStyle}>
          ...
          <span style={groupDescriptionStyle}>
            Connect a local Obsidian vault. DopaFlow writes daily journal notes
            as plain Markdown so your notes stay yours and work inside Obsidian.
          </span>
        </div>
        <VaultSettings />
      </section>
      <section style={groupStyle} id="settings-sync-sharing">
        ...
        <div style={groupHeaderStyle}>
          ...
          <span style={groupDescriptionStyle}>
            Connect remote storage and calendar feeds carefully. Keep the
            local-first default, then layer sharing on top only where it
            actually helps.
          </span>
        </div>
        <TursoConfig />
      ...
      <section style={groupStyle} id="settings-integrations">
        ...
        <div style={groupHeaderStyle}>
          ...
          <span style={groupDescriptionStyle}>
            Wire in outside systems without turning the app into a dashboard
            graveyard. Each integration should earn its place in the daily loop.
          </span>
        </div>
        <GmailConnect />
        <GitHubIntegration />
      ...
      <section style={groupStyle}>
        ...
        <div style={groupHeaderStyle}>
          ...
          <span style={groupDescriptionStyle}>
            Protect the data first. Backup, export, and recovery controls should
            stay obvious so the app remains trustworthy even when everything
            else changes.
          </span>
        </div>
        <BackupStatus
