...
export function VaultConflictList({
  ...
  previews: Record<string, VaultConflictPreview | undefined>;
  ...
  return (
    <div
      style={{
        ...cardStyle,
        borderColor:
          "color-mix(in srgb, var(--color-warn, #f87171) 40%, var(--border-subtle))",
      }}
    >
      <span style={{ ...labelStyle, color: "var(--color-warn, #f87171)" }}>
        {conflicts.length} conflict{conflicts.length > 1 ? "s" : ""} — both
        sides changed
      </span>
        ...
        >
          ...
          <div style={{ display: "flex", gap: "1rem", flexWrap: "wrap" }}>
            ...
            {conflict.last_direction && (
              ...
              >
                {directionLabel[conflict.last_direction] ??
                  conflict.last_direction}
                {conflict.last_synced_at
                  ? ` ${conflict.last_synced_at.slice(0, 16).replace("T", " ")}`
                  : ""}
              </span>
            )}
          </div>
          ...
          {previews[conflict.id] && (
            <div style={{ display: "grid", gap: "0.5rem" }}>
              ...
              >
                Snapshot is the last DopaFlow-indexed version. Vault is the
