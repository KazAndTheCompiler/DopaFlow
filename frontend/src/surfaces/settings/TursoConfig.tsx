  ...
  return (
    ...
    >
      <div style={{ display: 'grid', gap: '0.25rem' }}>
        ...
        >
          Keep the database URL on this device, then paste a token only when testing the connection.
          Tokens are not stored in this browser.
        </span>
      </div>
      {testState === 'error' && testError && (
        <div
          style={{
            ...
            borderRadius: '8px',
            background: 'color-mix(in srgb, var(--state-overdue) 10%, transparent)',
          }}
        >
          {testError}
        </div>
