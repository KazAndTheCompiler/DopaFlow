    ...
    >
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start' }}>
        <div style={{ flex: 1, minWidth: 0 }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem', flexWrap: 'wrap' }}>
            ...
            {goal.done && (
              <span
                style={{ fontSize: 'var(--text-xs)', color: 'var(--state-ok)', fontWeight: 700 }}
              >
                OK Done
              </span>
            )}
        ...
        <div style={{ display: 'flex', gap: '0.4rem', alignItems: 'center', flexShrink: 0 }}>
          <span
            style={{
              fontSize: 'var(--text-sm)',
              color: pct === 100 ? 'var(--state-ok)' : 'var(--text-secondary)',
              fontWeight: 700,
      ...
      {expanded && (
        <div style={{ display: 'grid', gap: '0.5rem', marginTop: '0.25rem' }}>
          ...
          {addingMilestone ? (
            <div
              style={{ display: 'flex', gap: '0.5rem', marginTop: '0.35rem', alignItems: 'center' }}
            >
              <input
