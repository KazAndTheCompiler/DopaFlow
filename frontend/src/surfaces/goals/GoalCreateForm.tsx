import { goalButtonStyle, goalCardStyle, goalInputStyle, type GoalCreateFormProps } from "./GoalsShared";
    ...
    <section style={{ ...goalCardStyle, display: "grid", gap: "0.85rem" }}>
      ...
      <div style={{ display: "grid", gap: "0.4rem" }}>
        ...
        <textarea
          ...
          rows={2}
          style={{ ...goalInputStyle, resize: "vertical", fontFamily: "inherit" }}
      ...
      <div style={{ display: "flex", gap: "1rem", alignItems: "flex-end", flexWrap: "wrap" }}>
        <div style={{ display: "grid", gap: "0.4rem" }}>
          ...
          <select
            value={horizon}
            onChange={(e) => onHorizonChange(e.target.value as GoalCreateFormProps["horizon"])}
