    ...
    >
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1rem' }}>
        <div>
          ...
          <div
            style={{ display: 'flex', alignItems: 'baseline', gap: '0.4rem', marginTop: '0.35rem' }}
          >
        ...
        {avgDaysToComplete !== null && (
          <div>
            ...
            >
              {avgDaysToComplete.toFixed(1)}
              <span style={{ fontSize: 'var(--text-sm)', fontWeight: 400 }}>d</span>
            </div>
          </div>
        )}
      </div>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '0.75rem' }}>
        <div>
          ...
          >
            ...
            <span style={{ fontSize: 'var(--text-sm)', fontWeight: 400 }}>h</span>
          </div>
        </div>
        {avgSessionMinutes !== null && (
          <div>
            ...
            >
              ...
              <span style={{ fontSize: 'var(--text-sm)', fontWeight: 400 }}>m</span>
            </div>
          </div>
        )}
      </div>
...
export default function InsightsView(): JSX.Element {
  ...
  const focusPatterns = useMemo((): FocusPatternData => {
    ...
    const durations = completed.map((s) => s.duration_minutes).filter((d) => d > 0);
