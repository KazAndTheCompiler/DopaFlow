...
export default function NutritionView(): JSX.Element {
  ...
  const load = async (): Promise<void> => {
    const [todayData, goalsData, foodsData] = await Promise.all([
      fetch(`${API_BASE_URL}/nutrition/today`)
        .then((r) => r.json())
        .catch(() => null),
    ...
    <div style={{ display: "grid", gap: "1rem" }}>
      ...
      <div style={{ ...cardStyle, display: "grid", gap: "0.75rem" }}>
        ...
        >
          ...
          <MacroBar
            label="Carbs"
            value={today?.total_carbs_g ?? 0}
            goal={goals.carbs_g}
            color="var(--state-warn)"
          />
          <MacroBar
            label="Fat"
            value={today?.total_fat_g ?? 0}
            goal={goals.fat_g}
            color="#8b5cf6"
          />
        </div>
        ...
        <div style={{ display: "grid", gap: "0.75rem" }}>
          ...
          <div style={cardStyle}>
            ...
            >
              <Input
                value={kj}
                onChange={(e) => setKj(e.currentTarget.value)}
                placeholder="kJ"
                type="number"
                min="0"
              />
              ...
              <Input
                value={carbs}
                onChange={(e) => setCarbs(e.currentTarget.value)}
                placeholder="Carbs g"
                type="number"
                min="0"
              />
              <Input
                value={fat}
                onChange={(e) => setFat(e.currentTarget.value)}
                placeholder="Fat g"
                type="number"
                min="0"
              />
        ...
        <div style={{ ...cardStyle, display: "grid", gap: "0.75rem" }}>
          ...
          >
            <div>
              ...
              <Input
                value={goalKj}
                onChange={(e) => setGoalKj(e.currentTarget.value)}
                type="number"
                min="0"
              />
            </div>
            <div>
              ...
              <Input
                value={goalProtein}
                onChange={(e) => setGoalProtein(e.currentTarget.value)}
                type="number"
                min="0"
              />
            </div>
            <div>
              ...
              <Input
                value={goalCarbs}
                onChange={(e) => setGoalCarbs(e.currentTarget.value)}
                type="number"
                min="0"
              />
            </div>
            <div>
              ...
              <Input
                value={goalFat}
                onChange={(e) => setGoalFat(e.currentTarget.value)}
                type="number"
                min="0"
              />
            </div>
