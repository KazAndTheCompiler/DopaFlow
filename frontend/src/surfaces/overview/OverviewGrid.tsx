  ...
  return (
    <div style={gridStyle}>
      <div style={cardStyle}>
        ...
        <div style={valueStyle}>{props.momentum !== null && props.momentum !== undefined ? Math.round(props.momentum) : "—"}</div>
        <span style={{ fontSize: "var(--text-sm)", color: "var(--text-secondary)" }}>Focus + completion velocity</span>
      </div>
