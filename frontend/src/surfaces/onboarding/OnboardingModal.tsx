      ...
      return (
        <div>
          ...
          >
            ...
            <h2
              style={{ fontSize: '1.95rem', fontWeight: 800, margin: 0, letterSpacing: '-0.04em' }}
            >
              Welcome to DopaFlow
            </h2>
      ...
      return (
        <div>
            ...
            {habits.map((h) => (
              <button
                ...
                style={{
                  ...
                  borderRadius: '14px',
                  border: '1.5px solid',
                  borderColor: selected.has(h.id) ? 'var(--accent)' : 'var(--border-subtle)',
          ...
          <div style={{ display: 'flex', gap: '0.5rem' }}>
            ...
            <Button onClick={() => setStep(2)} variant="primary" style={{ flex: 1 }}>
              Continue
            </Button>
          </div>
        </div>
