...
export function FocusPanel({ isActive, onStart, tasks = [], onTaskSelect }: FocusPanelProps): JSX.Element {
            ...
            >
              ...
              {selectedTask ? (
                <span
                  ...
                  style={{ fontSize: "var(--text-xs)", color: "var(--text-secondary)", flexShrink: 0, cursor: "pointer" }}
                >
                  ×
                </span>
              ) : (
                ...
                {pendingTasks.map((task) => (
                  <button
                    ...
                    style={{
                      ...
                      borderRadius: "8px",
                      border: selectedTaskId === task.id ? "1px solid color-mix(in srgb, var(--accent) 30%, transparent)" : "1px solid transparent",
        ...
        <div style={{ display: "flex", gap: "0.35rem" }}>
          {PRESETS.map(({ label, minutes }) => (
            <button
              ...
              style={{
                ...
                borderRadius: "8px",
                border: "1px solid",
                borderColor: selected === minutes && customMinutes === "" ? "var(--accent)" : "var(--border-subtle)",
                background: selected === minutes && customMinutes === "" ? "var(--accent)" : "transparent",
                color: selected === minutes && customMinutes === "" ? "var(--text-inverted)" : "var(--text-secondary)",
                cursor: isActive ? "default" : "pointer",
                fontSize: "var(--text-sm)",
                fontWeight: 600,
          ...
          <input
            ...
            style={{
              ...
              background: customMinutes !== "" ? "color-mix(in srgb, var(--accent) 10%, var(--surface))" : "transparent",
