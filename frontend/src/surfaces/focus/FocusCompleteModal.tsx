    ...
    <Modal open title="" onClose={onDismiss}>
      ...
      >
        ...
        <div style={{ textAlign: "center" }}>
          ...
          >
            Close the loop on the block now: mark the task done, take a real
            break, or roll straight into the next session.
          </p>
        </div>
        ...
        >
          ...
          >
            ...
            <strong style={{ fontSize: "var(--text-base)" }}>
              {taskTitle ? "close task or recover" : "recover or restart"}
            </strong>
            <span
              style={{
                fontSize: "var(--text-xs)",
            ...
            >
              don’t leave the transition fuzzy
            </span>
          </div>
        </div>
