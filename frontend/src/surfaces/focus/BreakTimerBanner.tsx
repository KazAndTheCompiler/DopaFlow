...
export function BreakTimerBanner({ breakEndsAt, onDismiss }: BreakTimerBannerProps): JSX.Element | null {
    ...
    >
      <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", gap: "0.75rem" }}>
        <div style={{ display: "grid", gap: "0.15rem" }}>
          <span style={{ fontSize: "var(--text-xs)", textTransform: "uppercase", letterSpacing: "0.08em", color: "var(--state-completed, #4ade80)", fontWeight: 800 }}>
            Break
          </span>
