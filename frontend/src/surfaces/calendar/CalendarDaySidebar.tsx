              ...
              <div style={{ display: "grid", gap: "0.25rem" }}>
                ...
                <div style={{ display: "grid", gridTemplateColumns: "repeat(2, minmax(0, 1fr))", gap: "0.45rem" }}>
                  <input
                    ...
                    onChange={(event) => onSetBlockDurationHours(Math.max(0, Number(event.target.value) || 0))}
                    placeholder="Hours"
                  ...
                  <input
                    ...
                    onChange={(event) => onSetBlockDurationMinutes(Math.max(0, Number(event.target.value) || 0))}
                    placeholder="Minutes"
