    ...
    <div style={{ display: "grid", gap: "0.75rem", minWidth: 0 }}>
      ...
      >
        <strong style={{ fontSize: "var(--text-sm)" }}>
          {prefillHour !== null
            ? `Block ${String(prefillHour).padStart(2, "0")}:00`
            : "Time block"}
        </strong>
        <input
          value={prefillTitle}
        ...
        {prefillHour !== null && (
          <>
            ...
            >
              Total duration: {totalDurationMinutes} minute
            ...
            >
              ...
              {blockReminder && (
                <select
                  ...
                  onChange={(event) =>
                    onSetBlockReminderOffset(Number(event.target.value))
                  }
                  style={{
