...
export function CalendarPanel({ onCreate, onVoiceExecuted }: CalendarPanelProps): JSX.Element {
  ...
  return (
    ...
    >
      ...
      <div style={{ display: "grid", gap: "0.25rem" }}>
        <label style={{ fontSize: "var(--text-xs)", color: "var(--text-secondary)", textTransform: "uppercase", letterSpacing: "0.06em" }}>Category</label>
        <select
          value={category}
      ...
      <div style={{ display: "grid", gap: "0.25rem" }}>
        <label style={{ fontSize: "var(--text-xs)", color: "var(--text-secondary)", textTransform: "uppercase", letterSpacing: "0.06em" }}>Repeats</label>
        <select
          value={recurrence}
