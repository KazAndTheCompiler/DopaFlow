    ...
    >
      <div style={{ display: "grid", gap: "0.2rem", flex: "1 1 100%" }}>
        <strong style={{ fontSize: "var(--text-base)" }}>
          Quick add calendar block
        </strong>
        <span
          style={{ color: "var(--text-secondary)", fontSize: "var(--text-sm)" }}
        >
          Drop a task, meeting, or focus block into the schedule without opening
          a separate editor.
        </span>
      </div>
      <div style={{ flex: "1 1 180px", display: "grid", gap: "0.25rem" }}>
        ...
        <input
          ...
          style={{
            ...
            boxShadow:
              "inset 0 1px 0 color-mix(in srgb, var(--surface) 82%, white 18%)",
          }}
        />
      </div>
      ...
      <div style={{ display: "grid", gap: "0.25rem" }}>
        ...
        >
          <input
            ...
            value={durationHours}
            onChange={(e) =>
              setDurationHours(Math.max(0, Number(e.target.value) || 0))
            }
      ...
      <button
        ...
        style={{
          ...
          alignSelf: "flex-end",
          boxShadow:
            title.trim() && !submitting ? "var(--shadow-soft)" : "none",
        }}
      >
