  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          {quadrant.events.length} event
          {quadrant.events.length !== 1 ? "s" : ""}
        </span>
      </div>
      <div
        style={{ display: "grid", gap: "0.4rem", padding: "0 0.75rem 0.75rem" }}
      >
...
export default function CalendarEisenhowerView({
  ...
  const quadrants: EisenhowerQuadrant[] = [
    {
      ...
      borderColor:
        "color-mix(in srgb, var(--state-overdue) 35%, var(--border-subtle))",
    ...
    },
    {
      ...
      borderColor:
        "color-mix(in srgb, var(--state-warn) 35%, var(--border-subtle))",
    ...
    },
    {
      ...
      borderColor:
        "color-mix(in srgb, var(--text-muted) 25%, var(--border-subtle))",
  ...
  return (
    <div style={{ display: "grid", gap: "0.65rem" }}>
      ...
      >
        Urgency = starts within 48 h · Importance = Work or Focus category.
