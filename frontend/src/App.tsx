    ...
    >
      ...
      >
        <div style={{ display: 'grid', gap: '0.35rem' }}>
          ...
          <span style={{ color: 'var(--text-secondary)', lineHeight: 1.6 }}>
            If you are running DopaFlow locally, make sure the FastAPI server started successfully
            and is reachable from the desktop app.
          </span>
        </div>
        <button
...
export default function App(): JSX.Element {
  ...
  useEffect(() => {
    ...
    return () =>
      window.removeEventListener('dopaflow:open-shutdown', openShutdown as EventListener);
  }, [overlay]);
